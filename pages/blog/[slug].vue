  ...
  <div v-if="post">
    ...
    <section class="relative">
      ...
      <div class="w-full h-[40vh] md:h-[50vh] overflow-hidden relative">
        <div
          class="absolute inset-0 bg-gradient-to-b from-gray-900/70 to-gray-900/40 z-10"
        ></div>
        <NuxtImg
          v-if="post.image"
          :src="post.image"
          ...
          <div class="container-custom">
            <div class="max-w-3xl">
              <div class="flex items-center space-x-4 mb-4">
                <span
                  class="inline-block px-3 py-1 bg-primary-600 text-white text-sm rounded-full"
                >
                  {{ post.category }}
                </span>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-12 gap-12">
          ...
          <div class="lg:col-span-8">
            <div class="prose prose-lg dark:prose-invert max-w-none mb-12">
              ...
              <p>
                As web development continues to evolve at a rapid pace, staying
                ahead of emerging trends is crucial for developers, designers,
                and businesses alike. In this article, we'll explore the most
                significant trends that are expected to shape the web
              ...
              <p>
                JavaScript frameworks have been the backbone of modern web
                development for years now. Looking ahead to 2025, we're seeing a
                significant shift in how these frameworks are being developed
                and used. The focus is increasingly on performance, developer
                experience, and sustainability.
              </p>

              <p>
                React, Vue, and Angular continue to dominate the landscape, but
                we're seeing a new generation of frameworks that prioritize:
              </p>

              <ul>
                <li>
                  <strong>Island architecture</strong> - Breaking down
                  applications into independently deployable islands
                </li>
                <li>
                  <strong>Zero-bundle approach</strong> - Shipping minimal
                  JavaScript to the client
                </li>
                <li>
                  <strong>Hybrid rendering</strong> - Combining the best of
                  server and client rendering
                </li>
                <li>
                  <strong>Enhanced type safety</strong> - Leveraging
              ...
              <p>
                ...
                process itself. From code completion to automated testing and
                optimization, AI tools are transforming how developers work.
              </p>

              <p>
                Some of the most promising applications of AI in web development
                include:
              </p>
              ...
              <p>
                WebAssembly (Wasm) continues to gain traction as a powerful
                compilation target for the web. By 2025, we anticipate Wasm will
                become mainstream, allowing developers to:
              </p>
              ...
              <ul>
                ...
                <li>
                  Create sophisticated browser-based applications like CAD
                  software, video editors, and games
                </li>
                <li>
                  Implement compute-intensive features without sacrificing
                  performance
                </li>
              </ul>
              ...
              <p>
                The future of web development looks incredibly promising. With
                advancements in AI, WebAssembly, and JavaScript frameworks,
                developers have more powerful tools than ever to create
                exceptional web experiences. By staying informed about these
                trends and continuously learning, web developers can position
            ...
            <div class="flex flex-wrap gap-2 mb-12">
              <span
                class="px-3 py-1 bg-gray-100 dark:bg-gray-800 text-sm rounded-full text-gray-700 dark:text-gray-300"
              >
                Web Development
              </span>
              <span
            ...
            <div class="border-t border-gray-200 dark:border-gray-700 pt-8">
              ...
              <div class="flex space-x-4">
                <a
                  href="#"
                  class="h-10 w-10 rounded-full bg-gray-100 dark:bg-gray-800 flex items-center justify-center text-gray-600 hover:bg-blue-100 hover:text-blue-600 dark:text-gray-400 dark:hover:bg-blue-900/30 dark:hover:text-blue-400 transition-colors duration-300"
                >
          ...
          <div class="lg:col-span-4">
            <!-- Author Card -->
            <div
              class="bg-gray-50 dark:bg-gray-800 p-6 rounded-lg shadow-sm mb-8"
            >
              ...
              <p class="text-gray-600 dark:text-gray-300 mb-4">
                Passionate about creating beautiful, user-friendly digital
                experiences. Sharing insights on web development, design, and
                technology.
              </p>
            ...
            <!-- Recent Posts -->
            <div
              class="bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-lg shadow-sm mb-8 overflow-hidden"
            >
              <div
              ...
              <div class="divide-y divide-gray-200 dark:divide-gray-700">
                ...
                >
                  <NuxtLink :to="`/blog/${recentPost.slug}`" class="group">
                    <h4
                      class="text-lg font-medium text-gray-900 dark:text-white group-hover:text-primary-600 dark:group-hover:text-primary-400 transition-colors duration-300 mb-2"
                    >
                      {{ recentPost.title }}
                    </h4>
                    <div
...
const slug = (route.params.slug || "").toString().trim();

// Fetch the current post from Nuxt Content
const { data: contentPost } = await useAsyncData(
  `blog-content-${slug}`,
  async () => {
...
// Only use contentPost from useAsyncData for post
const post = computed(() => contentPost.value);
...
const blogCategories = computed(() => {
  ...
  return [
    ...new Set(allPosts.value.map((post) => post.category).filter(Boolean)),
  ];
});
...
const relatedPosts = computed(() => {
  ...
  const sameCategoryPosts = allPosts.value.filter(
  ...
  const otherPosts = allPosts.value.filter(
    (p) =>
